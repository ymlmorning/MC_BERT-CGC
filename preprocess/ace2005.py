...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', help='Path to the input folder',default='data/ace05/data')
    parser.add_argument('-o', '--output', help='Path to the output folder',default='outputs/ace2005/')
