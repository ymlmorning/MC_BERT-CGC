...
def wordpunct_tokenize(text: str, language: str = 'chinese') -> List[str]:
...
def read_sgm_file(path: str, entities,
                  language: str = 'chinese') -> List[Tuple[str, int, int]]:
...
def convert_batch(input_path: str,
    ...
    with open(output_path, 'w', encoding='utf-8') as w:
        for sgm_file in sgm_files:
            ...
            doc = convert(sgm_file, apf_file, time_and_val=time_and_val, language='chinese')
